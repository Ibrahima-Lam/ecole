                            ...
                            <td data-salleclasse="<?= $prof->matriculeProfesseur ?>" data-horaire="<?= $horaire->codeHoraire ?>" data-jour="<?= $jour->codeJour ?>">
                                ...
                                ?>
                                    <div class="planning-entry">
                                        <strong><a href="?p=planning/table_classes/<?= $planningEntry->codeSalleClasse ?>"><?= $classeName ?></a></strong><br>
                                        <em><?= $matiereName ?></em>
                                    </div>
                                <?php else: ?>
...
<div class="fixed-action">
    <?php if ($_admin ?? false): ?>
        <?php $href = $matriculeProfesseur ? "?p=pdf/planning/table_profs/$matriculeProfesseur" : "?p=pdf/planning/table_profs"; ?>
