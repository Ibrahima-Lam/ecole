...
<body>
    <table class="table">
        <tbody>
            <tr>
                ...
                <th style="width: 15%;">
                    <center> <img src="images/logo_ministere.jpeg" style="width: 80px; height: 80px;"> </center>
                </th>
            ...
            <tbody>
                ...
                <?php if ($paramettre->nni): ?>
                    <tr>
                        <th>NNI</th>
                        <td colspan="2">
                            <center><?= $bulletin->eleve->nni ?></center>
                        </td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <center>
                            <strong><?= $bulletin->eleve->codeClasse ?><?= $bulletin->eleve->indiceSalleClasse ?></strong>
                        </center>
                    </td>
    ...
    <div class="table-container">
        <table
            class="table <?= $paramettre->striped ? 'table-striped' : '' ?> <?= $paramettre->bordered ? 'table-bordered' : '' ?>">
