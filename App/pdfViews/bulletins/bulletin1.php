                 ...
                 <tbody>
                     ...
                     <tr>
                         ...
                         <td><?php if($paramettre->rang):?>
                            <strong><?= $bulletin->getRang() ?></strong>
                      ...
                      <tr>
                          ...
                          <td><?php if($paramettre->decision):?>
                            <strong><?=$paramettre->mention_decision ?$bulletin->getDecisionMention(): $bulletin->getDecision() ?></strong>
                         <?php else:?>&nbsp; <?php endif?></td>
                     ...
                     <tr>
                         ...
                         <td><?php if($paramettre->mention):?>
                            <strong><?= $bulletin->getMension() ?></strong>
                         <?php else:?>&nbsp; <?php endif?></td>
