...
trait InscriptionTrait{
    ...
    public function profil($matricule){
        ...
        $subsidebar =strtolower(self::class) == strtolower("App\Controllers\https\inscritController") ? $this->subsidebar( 11) : $this->subsidebar($matricule, 1);
    ...
    public function inscrit()
    {
        ...
        $subsidebar =strtolower(self::class) == strtolower("App\Controllers\https\inscritController") ? $this->subsidebar( 11) : $this->subsidebar(null, 11);
