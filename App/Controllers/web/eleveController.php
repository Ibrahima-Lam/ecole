...
class EleveController extends WebController implements EleveControllerInterfaces
{
    ...
    public function bulletin1(bulletinServiceProvider $bulletinServiceProvider, ClasseBulletinServiceProvider $classeBulletinServiceProvider, EleveService $eleveService,string $matricule): void
    {
