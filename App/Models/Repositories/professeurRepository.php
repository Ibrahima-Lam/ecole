...
class ProfesseurRepository extends Repository
{
    ...
    public function insert(string $matricule, string  $nom, ?string $isme, ?string  $sexe, ?string  $adresse, ?string  $nni, ?string $codeSpecialite, ?string $dateDebut, ?string $dateArrivee, ?string $tel, ?string $email,?string $statut): bool
    {
        $sql = "insert into professeur(matriculeProfesseur,nomProfesseur,ismeProfesseur,sexeProfesseur,adresseProfesseur,nniProfesseur,codeSpecialite,dateDebutProfesseur,dateArriveeProfesseur,telProfesseur,emailProfesseur,statutProfesseur) values(:matriculeProfesseur,:nomProfesseur,:ismeProfesseur,:sexeProfesseur,:adresseProfesseur,:nniProfesseur,:codeSpecialite,:dateDebutProfesseur,:dateArriveeProfesseur,:telProfesseur,:emailProfesseur,:statutProfesseur)";
