...
(() => {
    ...
    a.document, z.documentElement && z.head && "function" == typeof z.addEventListener && z.createElement, 
    ...
    (o = a || {})[m] || (o[m] = {}), o[m].styles || (o[m].styles = {}), o[m].hooks || (o[m].hooks = {}), 
    o[m].shims || (o[m].shims = []);
    var d = o[m];
    function u(a) {
    ...
    function h(c, l, s) {
        var {
            skipHooks: a = !1
        } = 2 < arguments.length && void 0 !== s ? s : {}, z = u(l);
        "function" != typeof d.hooks.addPack || a ? d.styles[c] = f(f({}, d.styles[c] || {}), z) : d.hooks.addPack(c, u(l)), 
        "fas" === c && h("fa", l);
    }
    var g = {
